 ...
 * @author leonardo
 */
public class Registro_Tarjeta1 extends javax.swing.JDialog {

    /**
     * Creates new form Registro_Tarjeta
     */
    public Registro_Tarjeta1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Registro_Tarjeta1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Registro_Tarjeta1 dialog = new Registro_Tarjeta1(new javax.swing.JFrame(), true);
