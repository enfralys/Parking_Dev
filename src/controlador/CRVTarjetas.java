...
public class CRVTarjetas implements ActionListener, KeyListener{
    ...
    public CRVTarjetas(Main vista, RegistroVehiculo reg, RegistroPeaton regPea, VisorTarjeta regT){
...
//        vista.setTlbHistorialDatos(conn.CargarTablaConsulta(vista.getTlbHistorialDatos()));
    ...
    public void actPuesto(int p){
        ...
        CRVTarjetas control = new CRVTarjetas(vista,reg,regPea, regT);
        reg.puesto=p;
        control.InicioReg();
        conn.conectarSQLITE();
    ...
    private void registro() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if ((userNameValue.equals(this.user)) && (passwordValue.equals(this.pass))){
              regT = new VisorTarjeta(vista, true);
              CRVTarjetas control = new CRVTarjetas(vista,reg,regPea, regT);
              control.InicioRegT();
