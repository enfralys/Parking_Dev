...
public class CRTarjetas implements ActionListener, KeyListener{
    ...
    public CRTarjetas(Main vista, RegistroVehiculo reg, RegistroPeaton regPea, Registro_Tarjeta regT){
    ...
    public void actPuesto(int p){
        ...
        CRTarjetas control = new CRTarjetas(vista,reg,regPea, regT);
        reg.puesto=p;
        control.InicioReg();
        conn.conectarSQLITE();
